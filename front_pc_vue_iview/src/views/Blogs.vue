<template>
  <Row type="flex" justify="center">
    ...
    <Col span="5" style="margin-top:10px;">
      <Card>
        <div style="display:flex;align-items: center;flex-direction: column;">
          ...
          <div style="margin-top:10px;">
            ...
            <Tooltip content="1072474755" placement="top">
              <a href="tencent://message/?uin=1072474755&Site=sc.chinaz.com&Menu=yes" style="margin-right:3px;">
                <svg
                  t="1583326068309"
                  class="icon"
                  viewBox="0 0 1024 1024"
            ...
            <Tooltip content="1072474755" placement="top">
              <a href="weixin://" style="margin-right:3px;" >
                <svg
                  t="1583326453870"
                  class="icon"
                  viewBox="0 0 1024 1024"
            ...
            <Tooltip content="peter064226@hotmail.com" placement="top">
              <a href="mailto:peter064226@hotmail.com" >
                <svg
                  t="1589549743472"
                  class="icon"
                  viewBox="0 0 1024 1024"
                ...
                >
                  <path
                    d="M512 0Q294 5 149.5 149.5T0 512q5 218 149.5 362.5T512 1024q218-5 362.5-149.5T1024 512q-5-218-149.5-362.5T512 0z m300 297L512 549 213 297h599z m-601 22l200 169-200 239V319z m23 408l191-225 87 72 88-75 191 228H234z m579 0L613 488l200-169v408z"
                    p-id="5641"
                    fill="#0094ff"
                  />
                </svg>
      ...
      <Card style="margin-top:10px;">
        <div slot="title" style="font-size:13px;color:gray;">移动端</div>
...
import { Row, Col, Affix, Card, Tooltip } from "view-design";
export default {
  name: "blogsPage",
  components: {
    Blogs,
  ...
  mounted() {
    ...
    QRCode.toCanvas(
      canvas,
      "http://blog064226.herokuapp.com/public/h5/index.html",
      { scale: "3", color: { dark: "#aaaaaa" } },
      function(error) {
